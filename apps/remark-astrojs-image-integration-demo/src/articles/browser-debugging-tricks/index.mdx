import Chrome from '@components/browsers/Chrome.astro'
import Edge from '@components/browsers/Edge.astro'
import Firefox from '@components/browsers/Firefox.astro'
